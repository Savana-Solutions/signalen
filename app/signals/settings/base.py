...
# app.
API_PDF_LOGO_STATIC_FILE = os.getenv('API_PDF_LOGO_STATIC_FILE', 'api/logo-savana.webp')
...
SIGNAL_API_CONTEXT_GEOGRAPHY_RADIUS = int(os.getenv(
    'SIGNAL_API_CONTEXT_GEOGRAPHY_RADIUS', '50'
))  # Radius in meters

SIGNAL_API_CONTEXT_GEOGRAPHY_CREATED_DELTA_WEEKS = int(os.getenv(
