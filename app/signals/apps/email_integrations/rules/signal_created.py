...
class SignalCreatedRule(AbstractRule):
    def _validate_status(self, status):
        ...
        - The status REPORTED is the first and currently set status
        """
