...
class TestPrivateSignalViewSet(SIAReadUserMixin, SIAReadWriteUserMixin, SignalsBaseApiTestCase):
    ...
    @override_settings(DEBUG=True, SIGNALS_API_GEO_PAGINATE_BY=2)  # we need access to the DB queries here
    def test_geo_list_endpoint_queries(self):
        ...
        query = connection.queries[3]['sql']
        self.assertIn('LIMIT 2 OFFSET 2', query)
