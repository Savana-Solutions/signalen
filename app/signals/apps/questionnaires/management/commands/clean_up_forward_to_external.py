...
"""
For the FORWARDED_TO_EXTERN flow Session objects are prepared each time a
Signal is transitioned to FORWARDED_TO_EXTERN. These Session objects allow
...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        self.stdout.write('Invalidating sessions with FORWARDED_TO_EXTERN that are too old.')
